 ...
 */
public class InitializrMetadataBuildItemResolver implements BuildItemResolver {

	private final InitializrMetadata metadata;

	public InitializrMetadataBuildItemResolver(InitializrMetadata metadata) {
		this.metadata = metadata;
	}

	@Override
	public Dependency resolveDependency(String id) {
		return ConceptTranslator.toDependency(this.metadata.getDependencies().get(id));
	}
	...
	public MavenRepository resolveRepository(String id) {
		...
		return ConceptTranslator.toRepository(id,
